    ...
    <div className="patient-details-container">
      ...
      {isMobile && isMobileMenuOpen && (
        <div className="pd-mobile-nav">
          <div className="pd-mobile-nav-header">
            <h3>Navigation</h3>
            <button onClick={() => setIsMobileMenuOpen(false)}>
              <X size={20} />
            </button>
          </div>
          <div className="pd-mobile-nav-links">
            {!selectedPatient ? (
              <button 
                className="pd-mobile-nav-link active"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <User size={18} /> All Patients
              </button>
            ) : (
              <>
                <button 
                  className="pd-mobile-nav-link"
      ...
      {/* Main Header */}
      <div className={`pd-header ${isMobile ? 'pd-header-mobile' : ''}`}>
        {!isMobile && (
      ...
      {/* Search Bar */}
      <div className={`pd-search-container ${isMobile ? 'pd-search-mobile' : ''}`}>
      ...
      <div className={`pd-main-layout ${isMobile ? 'pd-main-mobile' : ''}`}>
                      ...
                      <tr key={record.id} className="pd-record-row">
                        <td data-label="Date">
                          <div className="pd-date-cell">
                            <Calendar size={14} />
                            <span className="pd-mobile-only">{record.date}</span>
                            <span className="pd-desktop-only">{record.date}</span>
                          </div>
                        </td>
                        <td data-label="Time">
                        ...
                        <td className="pd-problem-cell" data-label="Problem">
                          <div className="pd-problem-tag">{record.problem}</div>
                        </td>
                        <td className="pd-doctor-cell" data-label="Doctor">
                          {isMobile ? record.doctor.split(' ')[0] : record.doctor}
                        </td>
                        ...
                        <td data-label="Action">
                          ...
                          >
                            <FileText size={14} /> {isMobile ? 'View' : 'View Details'}
                          </button>
                        </td>
                      </tr>
                    ))}
          ...
          <div className="pd-record-detail-section">
            ...
            <div className="pd-detail-card">
              ...
              <div className="pd-detail-patient-banner">
                ...
                <div className="pd-detail-patient-info">
              ...
              <div className="pd-detail-grid">
                <div className="pd-detail-column">
                  ...
                  <div className="pd-detail-item">
                    <span className="pd-detail-label">Follow-up</span>
                ...
                <div className="pd-detail-column">
                  ...
                  <div className="pd-detail-item pd-detail-item-column">
              ...
              <div className="pd-detail-actions">
                ...
                >
                  {isDownloading ? (
                    ...
                    <>
                      <Download size={16} />
                      {isMobile ? 'Download PDF' : 'Download Prescription'}
                    </>
                  )}
                </button>
              </div>
      ...
      {isMobile && selectedPatient && (
        <div className="pd-mobile-bottom-nav">
          {selectedRecord ? (
            <button className="pd-mobile-nav-btn" onClick={handleBackToRecords}>
              <ChevronLeft size={20} />
              <span>Back to Visits</span>
            </button>
          ) : (
            <button className="pd-mobile-nav-btn" onClick={handleBackToPatients}>
              <ChevronLeft size={20} />
