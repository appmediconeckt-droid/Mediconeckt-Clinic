...
import ProfessionalProfileTable from "./components/DoctorDashboard/Setting/Profile/DoctorProfile";
import ProfileTab from "./components/PatientDashboard/PatientSetting/Profie/ProfileTab";
// import PatientDashboard from "./components/PatientDashboard/PatientDashboard";

function App() {
  // By default keep sidebar collapsed on large screens; hover will expand it
  ...
  const toggleSidebar = () => {
    // On mobile, toggle the open state only. On large screens we rely on hover to expand/collapse.
        ...
        <div className="main-content">
          ...
          >
            <Routes>
              ...
              <Route path="/doctor/profile" element={<ProfessionalProfileTable />} />
              ...
              <Route path="/chatbot" element={<ProfileTab />} />
